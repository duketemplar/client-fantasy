...
function hasConfig(key) {
  return !!(process.env.npm_package_config_karma_env && process.env.npm_package_config_karma_env.indexOf(key) !== -1);
}
...
module.exports = function(config) {
  config.set({
    ...
    frameworks: ['mocha', 'chai-sinon', 'es5-shim', 'es6-shim'], //use the mocha test framework
